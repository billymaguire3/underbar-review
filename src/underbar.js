(function() {
  ...
  _.each = function(collection, iterator) {
    ...
    if (Array.isArray(collection)) {
      ...
      for (var i = 0; i < collection.length; i++) {
        // invoke iterator on value index and collection
      ...
      for (var key in collection) {
        // invoke iterator on value key collection
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if (hashObj[argString] === undefined) {
        hashObj[argString] = func.apply(this, arguments);
      }
      return hashObj[argString];
    };
  ...
  _.shuffle = function(array) {
    ...
    _.each(array, function(value) {
      // genrates a random index
      var random = Math.floor(Math.random() * copy.length);
      // using random index as an argurmnt to splice to copy and pushing it to result
      result.push(copy.splice(random, 1)[0]);
    });
    return result;
  };
